...
using CleanArchitectureDemo.Application.TodoItems.Commands.CreateTodoItem;
using CleanArchitectureDemo.Application.TodoItems.Commands.DeleteTodoItem;
using CleanArchitectureDemo.Application.TodoItems.Commands.UpdateTodoItem;
using CleanArchitectureDemo.Application.TodoItems.Commands.UpdateTodoItemDetail;
using CleanArchitectureDemo.Application.TodoItems.Queries.GetTodoItemsWithPagination;
using Microsoft.AspNetCore.Http.HttpResults;

namespace CleanArchitectureDemo.Web.Endpoints;
